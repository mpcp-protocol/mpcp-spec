...
- **Architecture** — [System Model](architecture/system-model.md) (includes architecture diagram), [Authorization Chain](architecture/authorization-chain.md), [Actors](architecture/actors.md), [Reference Flow](architecture/fleet-ev-reference-flow.md)
- **Protocol** — [MPCP Spec](protocol/mpcp.md), [Artifacts](protocol/artifacts.md), and artifact definitions (PolicyGrant, SBA)
...
The reference implementation provides the canonical TypeScript SDK, verifier, Policy Authority server, Trust Bundle support, and on-chain adapters. See the [Integration Guide](guides/integration-guide.md) for a full stack walkthrough.
